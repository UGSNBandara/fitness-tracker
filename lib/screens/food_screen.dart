...
class _FoodScreenState extends State<FoodScreen> {
  ...
  Future<void> _loadNutritionData() async {
    ...
    try {
      final meals = await NutritionService.instance.loadDailyNutrition(
        DateTime.now(),
      );
      setState(() {
        _meals.clear();
  ...
  Future<void> _saveNutritionData() async {
    try {
      await NutritionService.instance.saveDailyNutrition(
        DateTime.now(),
        _meals,
      );
    } catch (e) {
  ...
  int get _totalCalories =>
      _meals.values.expand((e) => e).fold(0, (s, e) => s + e.calories);
  int get _totalProtein =>
      _meals.values.expand((e) => e).fold(0, (s, e) => s + e.protein);
  int get _totalCarbs =>
      _meals.values.expand((e) => e).fold(0, (s, e) => s + e.carbs);
  int get _totalFat =>
      _meals.values.expand((e) => e).fold(0, (s, e) => s + e.fat);
